...
@app.get("/author/{author_last_name}")
async def read_author2(author_last_name: str):
    author =  [val for (it,val) in enumerate(authors) if val.last_name == author_last_name]
